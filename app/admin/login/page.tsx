...
export default function AdminLoginPage() {
  ...
  return (
    <main className="admin-login-shell">
      ...
      <a className="admin-login-brand brand" href="/"><span className="brand-mark">/</span>studio<span className="brand-dot">●</span></a>
      <section className="admin-login-card" aria-labelledby="admin-login-title">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button className="button button-primary" type="submit" disabled={loading}>{loading ? 'Verificando…' : 'Entrar al panel'}<MoveRight size={17} /></button>
        </form>
        <a className="admin-back-link" href="/">Volver al sitio público <ArrowUpRight size={14} /></a>
      </section>
    </main>
  )
}
